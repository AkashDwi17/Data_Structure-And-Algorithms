...
public class Main {
    ...
    // All setup to find Minimum distence between 2 nodes
    public static Node lca2 (Node root, int n1, int n2){
        if  (root == null || root.data == n1 || root.data == n2){
            return root;
        }
        Node leftInfo = lca2 (root.left, n1, n2);
        Node rightInfo = lca2 (root.right, n1, n2);
        if (leftInfo == null){
            return rightInfo;
        }
        if (rightInfo == null){
    ...
    public static int lcaDist (Node root, int n){
        ...
        int leftInfo = lcaDist(root.left, n);
        int rightInfo = lcaDist(root.right, n);
    ...
    public static int minDistBetNode (Node root, int n1, int n2){
    ...
    public static void main (String args[]){
        ...
        int n1 = 4; 
        int n2 = 6;
        System.out.println(minDistBetNode(root, n1, n2));
    }
}